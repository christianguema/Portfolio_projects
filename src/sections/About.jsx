...
export function About() {
  return (
    ...
    >
      <RevealOnScroll>
        <ElectricBorder color="#FFA759" speed={0.4} chaos={0.06}>
          <div className="bg-surface border border-accent-2/20 rounded-lg aspect-square flex items-center justify-center">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4 mt-8">
            {[
              ...
              >
                <p className="font-display text-2xl text-accent-1">
                  {stat.value}
                </p>
                <p className="font-body text-xs text-text/60 mt-1">
                  {stat.label}
                </p>
              </div>
            ))}
